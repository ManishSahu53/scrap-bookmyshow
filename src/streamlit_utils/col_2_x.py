...
class Column_2_X_Loader:
    ...
    def get_col_2_3(self, col_2_3, movie_city, movie_name):
        ...
        movie_df_one_hour['status'] = movie_df_one_hour['avail_status'].apply(lambda x: self.mapping_avail_status.get(x))
        ...
        fig = px.bar(movie_df_one_hour_percentage, x='Date', y='percentage', color='status',
